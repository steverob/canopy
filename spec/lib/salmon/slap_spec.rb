...
describe Salmon::Slap do
  before do
    ...
    @created_salmon = Salmon::Slap.create_by_user_and_activity(alice, @post.to_Evergreen_xml)
  end
  ...
  it 'works' do
    ...
    salmon.parsed_data.should == @post.to_Evergreen_xml
  end
  ...
  describe "#process_header" do
    it 'sets the author id' do
      ...
      slap.author_id.should == alice.Evergreen_handle
    end
  end
  ...
  describe '#author' do
    ...
    it 'should fail if no author is found' do
      parsed_salmon.author_id = 'tom@tom.joinEvergreen.com'
      expect {
  ...
  context 'marshaling' do
    ...
    it 'should parse out the authors Evergreen_handle' do
      parsed_salmon.author_id.should == alice.person.Evergreen_handle
    end
    ...
    it 'contains the original data' do
      parsed_salmon.parsed_data.should == @post.to_Evergreen_xml
    end
  end
  ...
  describe "#xml_for" do
    ...
    it "has Evergreen as the root" do
      doc = Nokogiri::XML(@xml)
      doc.root.name.should == "Evergreen"
    end
    ...
    context "header" do
      ...
      it "it has author_id node " do
        ...
        search.map(&:text).should == [alice.Evergreen_handle]
      end
