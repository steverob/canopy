...
describe Rack::ChromeFrame do
  ...
  context "non-IE browser" do
    ...
    its(:body) { should_not =~ /Evergreen doesn't support your version of Internet Explorer/ }
  end
  ...
  context "IE7 without chromeframe" do
    ...
    its(:body) { should_not =~ /chrome=1/ }
    its(:body) { should =~ /Evergreen doesn't support your version of Internet Explorer/ }
