...
describe Notifier do
  ...
  describe ".private_message" do
    ...
    it "FROM: contains the sender's name" do
      @mail["From"].to_s.should == "\"#{@cnv.author.name} (Evergreen*)\" <#{AppConfig.mail.sender_address}>"
    end
  ...
  context "comments" do
    ...
    describe ".comment_on_post" do
      ...
      it "FROM: contains the sender's name" do
        comment_mail["From"].to_s.should == "\"#{eve.name} (Evergreen*)\" <#{AppConfig.mail.sender_address}>"
      end
