  ...
  describe '#update' do
    ...
    context 'with a profile photo set' do
      before do
        ...
        eve.person.profile.image_url = "http://tom.joinEvergreen.com/images/user/tom.jpg"
        eve.person.profile.save
      end
    ...
    context 'mass assignment' do
      ...
      it 'Evergreen handle' do
        put :update, @profile_params
        Person.find(eve.person.id).profile[:Evergreen_handle].should_not == 'abc@a.com'
      end
    end
  end
end
