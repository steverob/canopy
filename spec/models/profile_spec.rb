...
describe Profile do
  describe 'validation' do
    ...
    describe 'from_omniauth_hash' do
      ...
      it 'outputs a hash that can update a Evergreen profile' do
        profile = Profile.new
  ...
  describe '#image_url=' do
    before do
      ...
      @profile.image_url = "http://tom.joinEvergreen.com/images/user/tom.jpg"
  ...
  describe 'serialization' do
    let(:person) {FactoryGirl.build(:person,:Evergreen_handle => "foobar" )}

    it 'should include persons Evergreen handle' do
      xml = person.profile.to_Evergreen_xml
