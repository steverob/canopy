...
describe Photo do
  ...
  describe '#Evergreen_initialize' do
    before do
      @image = File.open(@fixture_name)
      @photo = Photo.Evergreen_initialize(
                :author => @user.person, :user_file => @image)
    end

    it 'sets the persons Evergreen handle' do
      @photo.Evergreen_handle.should == @user.person.Evergreen_handle
    end
  ...
  describe 'serialization' do
    ...
    it 'serializes the Evergreen_handle' do
      @xml.include?(@user.Evergreen_handle).should be true
    end
  ...
  describe 'remote photos' do
    ...
    it 'should set the remote_photo on marshalling' do
      ...
      xml = @saved_photo.to_Evergreen_xml
