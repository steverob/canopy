...
describe AccountDeleter do
  before do
    @account_deletion = AccountDeleter.new(bob.person.Evergreen_handle)
    @account_deletion.user = bob
  end

  it "attaches the user" do
    AccountDeleter.new(bob.person.Evergreen_handle).user.should == bob
    AccountDeleter.new(remote_raphael.Evergreen_handle).user.should == nil
  end
  ...
  describe '#perform' do
    ...
    context "person deletion" do
      before do
        @person_deletion = AccountDeleter.new(remote_raphael.Evergreen_handle)
      end
