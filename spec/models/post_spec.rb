...
describe Post do
  ...
  describe 'serialization' do
    it 'should serialize the handle and not the sender' do
      ...
      xml.include?(@user.person.Evergreen_handle).should be true
    end
  end
  ...
  describe '.Evergreen_initialize' do
    it 'takes provider_display_name' do
      ...
      StatusMessage.Evergreen_initialize(sm.attributes.merge(:author => bob.person)).provider_display_name.should == 'mobile'
    end
  end
