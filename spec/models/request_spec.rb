...
describe Request do
  ...
  describe 'validations' do
    before do
      @request = Request.Evergreen_initialize(:from => alice.person, :to => eve.person, :into => @aspect)
    end
    ...
    it 'is not to yourself' do
      @request = Request.Evergreen_initialize(:from => alice.person, :to => alice.person, :into => @aspect)
      @request.should_not be_valid
    end
  end
  ...
  describe '#receive' do
    ...
    it 'sets mutual if a contact already exists' do
      ...
      lambda {
        Request.Evergreen_initialize(:from => eve.person, :to => alice.person,
  ...
  context 'xml' do
    ...
    describe 'serialization' do
      it 'produces valid xml' do
        @xml.should include alice.person.Evergreen_handle
        @xml.should include eve.person.Evergreen_handle
