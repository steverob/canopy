...
describe 'a user receives a post' do
  ...
  it 'should be able to parse and store a status message from xml' do
    ...
    xml = status_message.to_Evergreen_xml
    bob.delete
  ...
  context 'with mentions, ' do
    it 'adds the notifications for the mentioned users regardless of the order they are received' do
      ...
      @sm = bob.build_post(:status_message, :text => "@{#{alice.name}; #{alice.Evergreen_handle}} stuff @{#{eve.name}; #{eve.Evergreen_handle}}")
    ...
    it 'notifies local users who are mentioned' do
      @remote_person = FactoryGirl.create(:person, :Evergreen_handle => "foobar@foobar.com")
      ...
      @sm = FactoryGirl.create(:status_message, :text => "hello @{#{alice.name}; #{alice.Evergreen_handle}}", :Evergreen_handle => @remote_person.Evergreen_handle, :author => @remote_person)
      @sm.save
    ...
    it 'does not notify the mentioned user if the mentioned user is not friends with the post author' do
      ...
      @sm = eve.build_post(:status_message, :text => "should not notify @{#{alice.name}; #{alice.Evergreen_handle}}")
  ...
  describe 'profiles' do
   it 'federates tags' do
     ...
     raph.profile.Evergreen_handle = "raph@remote.net"
     raph.profile.save!
     p = raph.profile
  ...
  describe 'post refs' do
    ...
    context 'dependent delete' do
      it 'deletes share_visibilities on disconnected by' do
        ...
        receive_with_zord(alice, @person, @post.to_Evergreen_xml)
    ...
    context 'remote' do
      before do
        fantasy_resque do
          ...
          @xml = comment.to_Evergreen_xml
          comment.delete

          comment_with_whitespace = alice.comment!(@post, '   I cannot lift my thumb from the spacebar  ')
          @xml_with_whitespace = comment_with_whitespace.to_Evergreen_xml
      ...
      it 'should correctly marshal a stranger for the downstream user' do
        ...
        m = mock()
        Webfinger.should_receive(:new).twice.with(eve.person.Evergreen_handle).and_return(m)
  ...
  context 'retractions' do
    it 'should accept retractions' do
      ...
      xml = retraction.to_Evergreen_xml
  ...
  it 'should marshal a profile for a person' do
    ...
    xml = new_profile.to_Evergreen_xml
