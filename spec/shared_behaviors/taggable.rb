...
describe Evergreen::Taggable do
  shared_examples_for "it is taggable" do
    ...
    describe '.format_tags' do
      ...
      it 'links each tag' do
        formatted_string = Evergreen::Taggable.format_tags(@str)
      ...
      it 'responds to plain_text' do
        Evergreen::Taggable.format_tags(@str, :plain_text => true).should == @str
      end
      ...
      it "doesn't mangle text when tags are involved" do
        ...
        expected.each do |input,output|
          Evergreen::Taggable.format_tags(input).should == output
        end
      end
    end
