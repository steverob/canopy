 ...
 *   the COPYRIGHT file.
 */
describe("Evergreen.Widgets.Notifications", function() {
  ...
  beforeEach(function() {
    ...
    notifications = Evergreen.BaseWidget.instantiate("Notifications", this.view.$("#notification_badge .badge_count"), this.view.$(".notifications"));
