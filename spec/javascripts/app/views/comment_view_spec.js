describe("app.views.Comment", function(){
  beforeEach(function(){
    this.post = factory.post({author : {Evergreen_id : "xxx@xxx.xxx"}})
  ...
  describe("render", function(){
    ...
    it("doesn't have a delete link if the author is not the current user", function(){
      loginAs(factory.author({Evergreen_id : "notbob@bob.com"}))
  ...
  describe("ownComment", function(){
    it("returns true if the author Evergreen_id == the current user's Evergreen_id", function(){
      loginAs(this.comment.get("author"))
      expect(this.view.ownComment()).toBe(true)
    })

    it("returns false if the author Evergreen_id != the current user's Evergreen_id", function(){
      loginAs(factory.author({Evergreen_id : "notbob@bob.com"}))
