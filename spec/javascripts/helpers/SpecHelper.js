...
beforeEach(function() {
  ...
  Evergreen.Pages.TestPage = function() {
    var self = this;
  ...
  var Page = Evergreen.Pages["TestPage"];
  $.extend(Page.prototype, Evergreen.EventBroker.extend(Evergreen.BaseWidget));

  Evergreen.page = new Page();
  Evergreen.page.publish("page/ready", [$(document.body)])
});
