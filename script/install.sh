...
one which includes cloning Evergreen/Evergreen, and one that assumes you already cloned it yourself
...
D_GIT_CLONE_PATH="/srv/Evergreen"     # path for Evergreen

D_REMOTE_REPO_URL="https://github.com/Evergreen/Evergreen.git"

D_INSTALL_SCRIPT_URL="https://raw.github.com/Evergreen/Evergreen/master/script/install.sh"

D_WIKI_URL="https://github.com/Evergreen/Evergreen/wiki"

D_IRC_URL="irc://freenode.net/Evergreen"
...
# setup database
# (assume we are in the Evergreen directory)
...
to get a DEVELOPMENT setup of Evergreen* up and running

For a PRODUCTION installation, please do *not* use this script!
Follow the guide in our wiki, instead:
-- https://github.com/Evergreen/Evergreen/wiki/Installation-Guides
...
# Evergreen config
log_inf "copying Evergreen.yml.example to Evergreen.yml"
run_or_error "cp config/Evergreen.yml.example config/Evergreen.yml"
printf "\n"
...
Now, you should have a look at
  ...
  - config/Evergreen.yml

and change them to your liking. Then you should be able to
start Evergreen* in development mode with:
