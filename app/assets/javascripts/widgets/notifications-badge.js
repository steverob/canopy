(function() {
  var NotificationDropdown = function() {
    ...
    this.renderNotifications = function() {
      ...
      self.dropdownNotifications.find('.unread').each(function(index) {
        Evergreen.page.header.notifications.setUpUnread( $(this) );
      });
      self.dropdownNotifications.find('.read').each(function(index) {
        Evergreen.page.header.notifications.setUpRead( $(this) );
      });
      self.dropdownNotifications.find('.unread').each(function(index) {
        var myItem = $(this);
        setTimeout(function(){
  ...
  Evergreen.Widgets.NotificationsDropdown = NotificationDropdown;
})();
