...
app.views.AspectMembership = Backbone.View.extend({
  ...
  _successSaveCb: function(aspect_membership) {
    ...
    if( this.dropdown.find('li.selected').length == 0 ) {
      var msg = Evergreen.I18n.t('aspect_dropdown.started_sharing_with', { 'name': this._name() });
      Evergreen.page.flashMessages.render({ 'success':true, 'notice':msg });
    }
  ...
  _displayError: function(msg_id) {
    ...
    var msg = Evergreen.I18n.t(msg_id, { 'name': this._name() });
    Evergreen.page.flashMessages.render({ 'success':false, 'notice':msg });
  },
  ...
  _successDestroyCb: function(aspect_membership) {
    ...
    if( this.dropdown.find('li.selected').length == 0 ) {
      var msg = Evergreen.I18n.t('aspect_dropdown.stopped_sharing_with', { 'name': this._name() });
      Evergreen.page.flashMessages.render({ 'success':true, 'notice':msg });
    }
  ...
  updateSummary: function() {
    ...
    if( aspects_cnt == 0 ) {
      ...
      txt = Evergreen.I18n.t('aspect_dropdown.toggle.zero');
    } else {
  ...
  _pluralSummaryTxt: function(cnt) {
    ...
    if( cnt == all_aspects_cnt ) {
      return Evergreen.I18n.t('aspect_dropdown.all_aspects');
    }

    return Evergreen.I18n.t('aspect_dropdown.toggle', { 'count':cnt.toString() });
  }
});
