...
require Rails.root.join('lib', 'Evergreen', 'markdownify')
...
module MarkdownifyHelper
  def markdownify(target, render_options={})
    ...
    renderer = Evergreen::Markdownify::HTML.new(render_options)
    ...
    message = Evergreen::Taggable.format_tags(message, :no_escape => true)
