module OpenGraphHelper
  ...
  def og_site_name
    meta_tag_with_property('og:site_name', 'Evergreen*')
  end
  ...
  def og_namespace(object)
    namespace = AppConfig.services.facebook.open_graph_namespace.present? ? AppConfig.services.facebook.open_graph_namespace : 'joinEvergreen'
    "#{namespace}:frame"
  end
