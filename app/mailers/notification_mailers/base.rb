module NotificationMailers
  ...
  class Base
    ...
    def default_headers
      ...
      headers[:from] = "\"#{@sender.name} (Evergreen*)\" <#{AppConfig.mail.sender_address}>" if @sender.present?
    ...
    def log_mail(recipient_id, sender_id, type)
      ...
      if @recipient && @sender
        log_string << "models_found=true sender_handle=#{@sender.Evergreen_handle} recipient_handle=#{@recipient.Evergreen_handle}"
      else
