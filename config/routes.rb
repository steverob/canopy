...
Evergreen::Application.routes.draw do
  ...
  get "/atom.xml" => redirect('http://blog.Evergreenfoundation.org/feed/atom') #too many stupid redirects :()
  ...
  #Protocol Url
  get 'protocol' => redirect("https://github.com/Evergreen/Evergreen/wiki/Evergreen%27s-federation-protocol")
