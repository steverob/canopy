...
module Salmon
 class Slap
    ...
    <Evergreen xmlns="https://joinEvergreen.com/protocol" xmlns:me="http://salmon-protocol.org/ns/magic-env">
      #{header(person)}
      #{@magic_sig.to_xml}
    </Evergreen>
ENTRY
    ...
    def plaintext_header
      header =<<HEADER
    <author_id>#{@author.Evergreen_handle}</author_id>
HEADER
    end
