class MovePhotosToTheirOwnTable < ActiveRecord::Migration
  def self.up
    ...
    if postgres?
      ...
      execute <<SQL
INSERT INTO photos
SELECT NULL as id, id AS tmp_old_id, author_id, public, Evergreen_handle, guid, pending, text, remote_photo_path, remote_photo_name, random_string, processed_image,
...
SQL
  ...
  def self.down
    if postgres?
      execute %{
        INSERT INTO posts (
          id, author_id, public, Evergreen_handle, guid, pending, type, text,
          ...
          tmp_old_id, author_id, public, Evergreen_handle, guid, pending, 'Photo', text,
          remote_photo_path, remote_photo_name, random_string, processed_image,
      ...
      execute <<SQL
INSERT INTO posts
  SELECT tmp_old_id AS id, author_id, public, Evergreen_handle, guid, pending, 'Photo' AS type, text, remote_photo_path, remote_photo_name, random_string,
